                      ...
                      int (*open_file)(OptionsContext*, const char*))
{
    ...
    for (i = 0; i < l->nb_groups; i++) {
        ...
        LOGE("ffmpeg_opt_open_files()......ret = %s",strerror(ret));
        if (ret < 0) {
            LOGE("ffmpeg_opt_open_files()......Error parsing options for");
            av_log(NULL, AV_LOG_ERROR, "Error parsing options for %s file "
                   "%s.\n", inout, g->arg);
            return ret;
        }
        LOGE("ffmpeg_opt_open_files()......Error parsing options for2");
        av_log(NULL, AV_LOG_DEBUG, "Opening an %s file: %s.\n", inout, g->arg);
        ret = open_file(&o, g->arg);
        LOGE("ffmpeg_opt_open_files()......ret2 = %s",strerror(ret));
        uninit_options(&o);
        if (ret < 0) {
            LOGE("ffmpeg_opt_open_files()......Error parsing file");
            av_log(NULL, AV_LOG_ERROR, "Error opening %s file %s.\n",
                   inout, g->arg);
            return ret;
        }
        LOGE("ffmpeg_opt_open_files()......Successfully opened the file");
...
{
    LOGE("ffmpeg_opt_ffmpeg_parse_options()......");
    ...
    LOGE("ffmpeg_opt_ffmpeg_parse_options()......ret = %s",strerror(ret));
    if (ret < 0) {
        LOGE("ffmpeg_opt_ffmpeg_parse_options()......Error splitting the argument list: ");
    ...
    LOGE("ffmpeg_opt_ffmpeg_parse_options()......ret2 = %s",strerror(ret));
    if (ret < 0) {
        LOGE("ffmpeg_opt_ffmpeg_parse_options()......Error parsing global options: ");
    ...
    LOGE("ffmpeg_opt_ffmpeg_parse_options()......ret3 = %s",strerror(ret));
    if (ret < 0) {
        LOGE("ffmpeg_opt_ffmpeg_parse_options()......Error opening input files: ");
    ...
    LOGE("ffmpeg_opt_ffmpeg_parse_options()......ret4 = %s",strerror(ret));
    if (ret < 0) {
        LOGE("ffmpeg_opt_ffmpeg_parse_options()......Error initializing complex filters.");
    ...
    LOGE("ffmpeg_opt_ffmpeg_parse_options()......ret5 = %s",strerror(ret));
    if (ret < 0) {
        LOGE("ffmpeg_opt_ffmpeg_parse_options()......Error opening output files: ");
