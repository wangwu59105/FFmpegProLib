...
import com.sf.ffmpeg.cmd.FFmpegCmd;
import com.sf.ffmpeg.cmd.FFmpegUtil;
...
//                String[] command =  FFmpegUtil.replaceVoiceAddWatermask("/sdcard/Pictures/1560138792324.jpg","/sdcard/dlj.mp3","/sdcard/ffmpeg/output_voice_water.mp4");
                ...
                String[] command =  FFmpegUtil.getVideoExtract("/storage/sdcard1/Android/data/com.sf.deepview/files/Deep/record/123.mp4","/storage/sdcard1/Android/data/com.sf.deepview/files/Deep/dms/",5);
                exec(command);
                break;
        }
    }
